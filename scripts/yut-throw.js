...
const yutthrow=extendContent(MessageBlock,"yut-throw",{
    placed(tile) {
...
*/
    ...
    update(tile){
      ...
      if(tile.ent().message!=""&&tile.ent().timer.getTime(timerid)>=landframe+79&&tile.ent().timer.getTime(timerid)<=landframe+81){
...
yutthrow.entityType=prov(() => extendContent(MessageBlock.MessageBlockEntity , yutthrow , {
  _friction:0.97,
  _g:-0.1,
  _yoot0:{
    x:0,
